...
```
ghcr.io/skillrepos/ai-security-devcontainer:latest
```
...
docker build --platform linux/amd64 -f .devcontainer/Dockerfile -t ghcr.io/skillrepos/ai-security-devcontainer:latest .

# 3. Push to GHCR
docker push ghcr.io/skillrepos/ai-security-devcontainer:latest
```
...
Go to: `github.com/orgs/skillrepos/packages/container/ai-security-devcontainer/settings`
